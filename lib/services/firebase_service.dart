...
class FirebaseService {
  ...
  Stream<List<Post>> getUserPostsStream(String userId, {int limit = 50}) {
    return _firestore
        .collection('posts')
          ...
          (snapshot) => snapshot.docs
              .map((doc) {
                try {
                  ...
                  print('Error parsing friend post ${doc.id}: $e');
                  return null;
                }
              })
              .whereType<Post>()
  ...
  Stream<List<Comment>> getCommentsStream(String postId) {
    ...
    return _firestore
        ...
        .map((snapshot) {
          print(
            'Comments snapshot received: ${snapshot.docs.length} documents',
          );
